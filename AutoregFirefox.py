...
if firefox_path:
    print(f"Найден Firefox по пути: {firefox_path}")
    firefox_options.binary_location = firefox_path
else:
    print("Firefox не найден автоматически. Укажите путь вручную:")
    firefox_path = input("Введите полный путь к firefox.exe: ")
    if os.path.exists(firefox_path):
        firefox_options.binary_location = firefox_path
    else:
        raise FileNotFoundError("Указанный путь к Firefox не существует")
